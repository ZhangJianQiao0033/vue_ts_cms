  ...
  <div class="user-content">
    ...
    <div class="table">
      <el-table :data="userList" style="width: 100%" border>
        ...
        <el-table-column prop="realname" label="真实姓名" align="center" width="150" />
        <el-table-column prop="cellphone" label="手机号码" align="center" width="130" />
        <el-table-column prop="enable" label="状态" align="center" width="100">
          <template #default="scope">
            <el-button :type="scope.row.enable === 1 ? 'primary' : 'danger'" size="default" plain>
...
function fetchUserList(queryInfo: any = {}) {
  const size = pageSize.value
  const offset = (currentPage.value - 1) * size
  systemStore.postUsersListAction({ size, offset, ...queryInfo })
}
...
//编辑功能
function editClick(userInfo: any) {
  emit('editUser', userInfo)
}
